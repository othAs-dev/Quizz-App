...
function showResults(results) {
  ...
  switch (errorsNumber) {
    case 0:
      titleResult.textContent = "Bravo, tu as un bon niveau JS 👏";
      helpResult.style.display = "block";
      helpResult.textContent = "Quelle culture, incroyable ! 🧠";
      markResult.style.display = "block";
      markResult.innerHTML = "Score <span>5/5</span>";
      break;
    case 1:
      titleResult.textContent = `✨ Tu y es presque ! ✨`;
      helpResult.textContent =
        "Retentes une autre réponse dans la case rouge, puis re-valide le formulaire !";
      helpResult.style.display = "block";
